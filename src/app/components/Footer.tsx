...
const Footer = () => {
  ...
  return (
    <div className="border-t p-12 border-zinc-500 min-h-40 flex justify-between bg-[#F3F3F3]">
      ...
      <div className="flex flex-col gap-1">
        ...
        <Link href="mailto:raiseyourvoicearoundtheworld@gmail.com">raiseyourvoicearoundtheworld@gmail.com</Link>
      </div>
      <div className="flex flex-col gap-1">
